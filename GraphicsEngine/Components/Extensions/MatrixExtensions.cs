...
{
    public static Matrix4x4 ToNumerics(this OpenTK.Mathematics.Matrix4 matrix4)
        => new Matrix4x4(
    ...
    public static Silk.NET.Maths.Matrix4X4<float> ToSilkOpenGL(this Matrix4x4 matrix4)
        => new Silk.NET.Maths.Matrix4X4<float>(
    ...
    public static OpenTK.Mathematics.Matrix4 ToOpenTK(this Matrix4x4 matrix4)
    ...
    public static ReadOnlySpan<float> ToReadOnlySpan(this Matrix4x4 matrix)
    {
        unsafe
        {
            return new ReadOnlySpan<float>(&matrix.M11, 16);
        }
    }
}